...
const ProjectCard = ({index, name, description, tags, image, source_code_link_github, source_code_link}) => {
  return(
    ...
    <>
      ...
      <div className='w-full flex'>
        <motion.p variants={fadeIn("", "", 0.1, 1)} className='mt-3 text-secondary text-[17px] max-w-3xl leading-[30px]'>
          The list of projects here were for learning and self exploration purpose to dive into the deep world of Web development. The list contains the recent portfolio projects to the projects from the start, when i started learning the web development during my internship.
        </motion.p>
      </div>
